...
"""
2020.7.3 ETRI 占쏙옙占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙 占쏙옙占실쇽옙(eschung@etri.re.kr)
챌占쏙옙占쏙옙占쏙옙 占쏠가쇽옙 占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙
"""
...
def main():
    ...
    p.add_argument("-model", "--IMPORTED_MODEL", default="D:/Workspace/Project_fashion/model/model_do05-511")
    p.add_argument("-dpath", "--DDATA_PATH",     default="D:/Workspace/Project_fashion/ddata.wst.txt.2020.6.23")
    p.add_argument("-mpath", "--MDATA_PATH",     default="D:/Workspace/Project_fashion/mdata.wst.txt.2020.6.23")
    p.add_argument("-epath", "--EVAL_PATH",      default="D:/Workspace/Project_fashion/ac_eval_t1.wst.dev")
